...
define void @apatb_calo_trigger_tower_stream_ref_ir(%"class.hls::stream<ap_uint<12>, 0>"* noalias nocapture nonnull dereferenceable(2) %tower_in, %"struct.ap_uint<12>"* nocapture readonly %em_seed_threshold, %"struct.ap_uint<20>"* nocapture readonly %em_cluster_threshold, %"struct.ap_uint<12>"* nocapture readonly %jet_seed_threshold, %"struct.ap_uint<20>"* nocapture readonly %jet_cluster_threshold, %struct.TriggerObject* noalias nocapture nonnull "fpga.decayed.dim.hint"="8" "partition" %em_objects, %struct.TriggerObject* noalias nocapture nonnull "fpga.decayed.dim.hint"="8" "partition" %jet_objects, %"struct.ap_uint<24>"* noalias nocapture nonnull %ht, i32* noalias nocapture nonnull %num_em_clusters, i32* noalias nocapture nonnull %num_jet_clusters) local_unnamed_addr #1 {
entry:
  %tower_in_copy = alloca i12, align 512
  call void @llvm.sideeffect() #10 [ "stream_interface"(i12* %tower_in_copy, i32 0) ]
  ...
  %0 = bitcast %struct.TriggerObject* %em_objects to [8 x %struct.TriggerObject]*
  %1 = bitcast %struct.TriggerObject* %jet_objects to [8 x %struct.TriggerObject]*
  call void @copy_in(%"class.hls::stream<ap_uint<12>, 0>"* nonnull %tower_in, i12* nonnull align 512 %tower_in_copy, [8 x %struct.TriggerObject]* nonnull %0, i89* nonnull align 512 %em_objects_copy_0, i89* nonnull align 512 %em_objects_copy_1, i89* nonnull align 512 %em_objects_copy_2, i89* nonnull align 512 %em_objects_copy_3, i89* nonnull align 512 %em_objects_copy_4, i89* nonnull align 512 %em_objects_copy_5, i89* nonnull align 512 %em_objects_copy_6, i89* nonnull align 512 %em_objects_copy_7, [8 x %struct.TriggerObject]* nonnull %1, i89* nonnull align 512 %jet_objects_copy_0, i89* nonnull align 512 %jet_objects_copy_1, i89* nonnull align 512 %jet_objects_copy_2, i89* nonnull align 512 %jet_objects_copy_3, i89* nonnull align 512 %jet_objects_copy_4, i89* nonnull align 512 %jet_objects_copy_5, i89* nonnull align 512 %jet_objects_copy_6, i89* nonnull align 512 %jet_objects_copy_7, %"struct.ap_uint<24>"* nonnull %ht, i24* nonnull align 512 %ht_copy, i32* nonnull %num_em_clusters, i32* nonnull align 512 %num_em_clusters_copy, i32* nonnull %num_jet_clusters, i32* nonnull align 512 %num_jet_clusters_copy)
  call void @apatb_calo_trigger_tower_stream_ref_hw(i12* %tower_in_copy, %"struct.ap_uint<12>"* %em_seed_threshold, %"struct.ap_uint<20>"* %em_cluster_threshold, %"struct.ap_uint<12>"* %jet_seed_threshold, %"struct.ap_uint<20>"* %jet_cluster_threshold, i89* %em_objects_copy_0, i89* %em_objects_copy_1, i89* %em_objects_copy_2, i89* %em_objects_copy_3, i89* %em_objects_copy_4, i89* %em_objects_copy_5, i89* %em_objects_copy_6, i89* %em_objects_copy_7, i89* %jet_objects_copy_0, i89* %jet_objects_copy_1, i89* %jet_objects_copy_2, i89* %jet_objects_copy_3, i89* %jet_objects_copy_4, i89* %jet_objects_copy_5, i89* %jet_objects_copy_6, i89* %jet_objects_copy_7, i24* %ht_copy, i32* %num_em_clusters_copy, i32* %num_jet_clusters_copy)
  call void @copy_back(%"class.hls::stream<ap_uint<12>, 0>"* %tower_in, i12* %tower_in_copy, [8 x %struct.TriggerObject]* %0, i89* %em_objects_copy_0, i89* %em_objects_copy_1, i89* %em_objects_copy_2, i89* %em_objects_copy_3, i89* %em_objects_copy_4, i89* %em_objects_copy_5, i89* %em_objects_copy_6, i89* %em_objects_copy_7, [8 x %struct.TriggerObject]* %1, i89* %jet_objects_copy_0, i89* %jet_objects_copy_1, i89* %jet_objects_copy_2, i89* %jet_objects_copy_3, i89* %jet_objects_copy_4, i89* %jet_objects_copy_5, i89* %jet_objects_copy_6, i89* %jet_objects_copy_7, %"struct.ap_uint<24>"* %ht, i24* %ht_copy, i32* %num_em_clusters, i32* %num_em_clusters_copy, i32* %num_jet_clusters, i32* %num_jet_clusters_copy)
  ret void
}

; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<12>, 0>"(%"class.hls::stream<ap_uint<12>, 0>"* noalias "unpacked"="0" %dst, i12* noalias nocapture align 512 "unpacked"="1.0" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<ap_uint<12>, 0>"* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<12>, 0>"(%"class.hls::stream<ap_uint<12>, 0>"* nonnull %dst, i12* align 512 %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<12>, 0>"(%"class.hls::stream<ap_uint<12>, 0>"* noalias nocapture "unpacked"="0", i12* noalias nocapture align 512 "unpacked"="1.0") unnamed_addr #3 {
entry:
  %2 = alloca i12
  %3 = alloca %"class.hls::stream<ap_uint<12>, 0>"
  br label %empty
...
push:                                             ; preds = %empty
  %6 = bitcast i12* %2 to i8*
  %7 = bitcast i12* %1 to i8*
  call void @fpga_fifo_pop_2(i8* %6, i8* %7)
  %8 = bitcast i12* %2 to i16*
  %9 = load i16, i16* %8
  %10 = trunc i16 %9 to i12
  %.ivi = insertvalue %"class.hls::stream<ap_uint<12>, 0>" undef, i12 %10, 0, 0, 0, 0
  store %"class.hls::stream<ap_uint<12>, 0>" %.ivi, %"class.hls::stream<ap_uint<12>, 0>"* %3
  %11 = bitcast %"class.hls::stream<ap_uint<12>, 0>"* %3 to i8*
...
define void @arraycpy_hls.p0a8struct.TriggerObject([8 x %struct.TriggerObject]* "orig.arg.no"="0" %dst, [8 x %struct.TriggerObject]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) local_unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>"(i24* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_uint<24>"* noalias readonly "unpacked"="1" %src) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>.73"(%"struct.ap_uint<24>"* noalias "unpacked"="0" %dst, i24* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<12>, 0>.82"(i12* noalias nocapture align 512 "unpacked"="0.0" %dst, %"class.hls::stream<ap_uint<12>, 0>"* noalias "unpacked"="1" %src) unnamed_addr #2 {
entry:
  %0 = icmp eq %"class.hls::stream<ap_uint<12>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<12>, 0>.85"(i12* align 512 %dst, %"class.hls::stream<ap_uint<12>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<ap_uint<12>, 0>.85"(i12* noalias nocapture align 512 "unpacked"="0.0", %"class.hls::stream<ap_uint<12>, 0>"* noalias nocapture "unpacked"="1") unnamed_addr #3 {
entry:
...
empty:                                            ; preds = %push, %entry
  %4 = bitcast %"class.hls::stream<ap_uint<12>, 0>"* %1 to i8*
  %5 = call i1 @fpga_fifo_not_empty_2(i8* %4)
  br i1 %5, label %push, label %ret

push:                                             ; preds = %empty
  %6 = bitcast %"class.hls::stream<ap_uint<12>, 0>"* %2 to i8*
  %7 = bitcast %"class.hls::stream<ap_uint<12>, 0>"* %1 to i8*
  call void @fpga_fifo_pop_2(i8* %6, i8* %7)
  %8 = load volatile %"class.hls::stream<ap_uint<12>, 0>", %"class.hls::stream<ap_uint<12>, 0>"* %2
  %.evi = extractvalue %"class.hls::stream<ap_uint<12>, 0>" %8, 0, 0, 0, 0
  store i12 %.evi, i12* %3
  %9 = bitcast i12* %3 to i8*
  %10 = bitcast i12* %0 to i8*
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8struct.TriggerObject.110.111(%struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, %struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, %struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, %struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.3" %dst_3, %struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.4" %dst_4, %struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.5" %dst_5, %struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.6" %dst_6, %struct.TriggerObject* "orig.arg.no"="0" "unpacked"="0.7" %dst_7, [8 x %struct.TriggerObject]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #4 {
entry:
  %0 = icmp eq [8 x %struct.TriggerObject]* %src, null
  %1 = icmp eq %struct.TriggerObject* %dst_0, null
  %2 = or i1 %1, %0
  br i1 %2, label %ret, label %copy
...
for.loop.lr.ph:                                   ; preds = %copy
  %dst.addr.0.0.0.08_0 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_0, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.0.0.0.08_1 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_1, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.0.0.0.08_2 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_2, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.0.0.0.08_3 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_3, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.0.0.0.08_4 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_4, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.0.0.0.08_5 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_5, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.0.0.0.08_6 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_6, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.0.0.0.08_7 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_7, i64 0, i32 0, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_0 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_0, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_1 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_1, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_2 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_2, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_3 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_3, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_4 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_4, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_5 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_5, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_6 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_6, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.1.0.0.016_7 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_7, i64 0, i32 1, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_0 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_0, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_1 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_1, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_2 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_2, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_3 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_3, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_4 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_4, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_5 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_5, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_6 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_6, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.2.0.0.024_7 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_7, i64 0, i32 2, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_0 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_0, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_1 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_1, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_2 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_2, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_3 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_3, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_4 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_4, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_5 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_5, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_6 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_6, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.3.0.0.032_7 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_7, i64 0, i32 3, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_0 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_0, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_1 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_1, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_2 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_2, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_3 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_3, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_4 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_4, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_5 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_5, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_6 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_6, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.4.0.0.040_7 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_7, i64 0, i32 4, i32 0, i32 0, i32 0
  %dst.addr.542_0 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_0, i64 0, i32 5
  %dst.addr.542_1 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_1, i64 0, i32 5
  %dst.addr.542_2 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_2, i64 0, i32 5
  %dst.addr.542_3 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_3, i64 0, i32 5
  %dst.addr.542_4 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_4, i64 0, i32 5
  %dst.addr.542_5 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_5, i64 0, i32 5
  %dst.addr.542_6 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_6, i64 0, i32 5
  %dst.addr.542_7 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_7, i64 0, i32 5
  %dst.addr.644_0 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_0, i64 0, i32 6
  %dst.addr.644_1 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_1, i64 0, i32 6
  %dst.addr.644_2 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_2, i64 0, i32 6
  %dst.addr.644_3 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_3, i64 0, i32 6
  %dst.addr.644_4 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_4, i64 0, i32 6
  %dst.addr.644_5 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_5, i64 0, i32 6
  %dst.addr.644_6 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_6, i64 0, i32 6
  %dst.addr.644_7 = getelementptr %struct.TriggerObject, %struct.TriggerObject* %dst_7, i64 0, i32 6
  br label %for.loop
...
dst.addr.644.case.0:                              ; preds = %for.loop
  store i20 %5, i20* %dst.addr.0.0.0.08_0, align 4
  %6 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %7 = load i24, i24* %6
  %8 = trunc i24 %7 to i20
  store i20 %8, i20* %dst.addr.1.0.0.016_0, align 4
  %9 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %10 = load i8, i8* %9
  %11 = trunc i8 %10 to i6
  store i6 %11, i6* %dst.addr.2.0.0.024_0, align 1
  %12 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %13 = load i8, i8* %12
  %14 = trunc i8 %13 to i6
  store i6 %14, i6* %dst.addr.3.0.0.032_0, align 1
  %15 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %16 = load i8, i8* %15
  %17 = trunc i8 %16 to i4
  store i4 %17, i4* %dst.addr.4.0.0.040_0, align 1
  %18 = load i32, i32* %src.addr.541, align 4
  store i32 %18, i32* %dst.addr.542_0, align 4
  %19 = bitcast i1* %src.addr.643 to i8*
  %20 = load i8, i8* %19
  %21 = trunc i8 %20 to i1
  store i1 %21, i1* %dst.addr.644_0, align 1
  br label %dst.addr.644.exit

dst.addr.644.case.1:                              ; preds = %for.loop
  store i20 %5, i20* %dst.addr.0.0.0.08_1, align 4
  %22 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %23 = load i24, i24* %22
  %24 = trunc i24 %23 to i20
  store i20 %24, i20* %dst.addr.1.0.0.016_1, align 4
  %25 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %26 = load i8, i8* %25
  %27 = trunc i8 %26 to i6
  store i6 %27, i6* %dst.addr.2.0.0.024_1, align 1
  %28 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %29 = load i8, i8* %28
  %30 = trunc i8 %29 to i6
  store i6 %30, i6* %dst.addr.3.0.0.032_1, align 1
  %31 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %32 = load i8, i8* %31
  %33 = trunc i8 %32 to i4
  store i4 %33, i4* %dst.addr.4.0.0.040_1, align 1
  %34 = load i32, i32* %src.addr.541, align 4
  store i32 %34, i32* %dst.addr.542_1, align 4
  %35 = bitcast i1* %src.addr.643 to i8*
  %36 = load i8, i8* %35
  %37 = trunc i8 %36 to i1
  store i1 %37, i1* %dst.addr.644_1, align 1
  br label %dst.addr.644.exit

dst.addr.644.case.2:                              ; preds = %for.loop
  store i20 %5, i20* %dst.addr.0.0.0.08_2, align 4
  %38 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %39 = load i24, i24* %38
  %40 = trunc i24 %39 to i20
  store i20 %40, i20* %dst.addr.1.0.0.016_2, align 4
  %41 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %42 = load i8, i8* %41
  %43 = trunc i8 %42 to i6
  store i6 %43, i6* %dst.addr.2.0.0.024_2, align 1
  %44 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %45 = load i8, i8* %44
  %46 = trunc i8 %45 to i6
  store i6 %46, i6* %dst.addr.3.0.0.032_2, align 1
  %47 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %48 = load i8, i8* %47
  %49 = trunc i8 %48 to i4
  store i4 %49, i4* %dst.addr.4.0.0.040_2, align 1
  %50 = load i32, i32* %src.addr.541, align 4
  store i32 %50, i32* %dst.addr.542_2, align 4
  %51 = bitcast i1* %src.addr.643 to i8*
  %52 = load i8, i8* %51
  %53 = trunc i8 %52 to i1
  store i1 %53, i1* %dst.addr.644_2, align 1
  br label %dst.addr.644.exit

dst.addr.644.case.3:                              ; preds = %for.loop
  store i20 %5, i20* %dst.addr.0.0.0.08_3, align 4
  %54 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %55 = load i24, i24* %54
  %56 = trunc i24 %55 to i20
  store i20 %56, i20* %dst.addr.1.0.0.016_3, align 4
  %57 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %58 = load i8, i8* %57
  %59 = trunc i8 %58 to i6
  store i6 %59, i6* %dst.addr.2.0.0.024_3, align 1
  %60 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %61 = load i8, i8* %60
  %62 = trunc i8 %61 to i6
  store i6 %62, i6* %dst.addr.3.0.0.032_3, align 1
  %63 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %64 = load i8, i8* %63
  %65 = trunc i8 %64 to i4
  store i4 %65, i4* %dst.addr.4.0.0.040_3, align 1
  %66 = load i32, i32* %src.addr.541, align 4
  store i32 %66, i32* %dst.addr.542_3, align 4
  %67 = bitcast i1* %src.addr.643 to i8*
  %68 = load i8, i8* %67
  %69 = trunc i8 %68 to i1
  store i1 %69, i1* %dst.addr.644_3, align 1
  br label %dst.addr.644.exit

dst.addr.644.case.4:                              ; preds = %for.loop
  store i20 %5, i20* %dst.addr.0.0.0.08_4, align 4
  %70 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %71 = load i24, i24* %70
  %72 = trunc i24 %71 to i20
  store i20 %72, i20* %dst.addr.1.0.0.016_4, align 4
  %73 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %74 = load i8, i8* %73
  %75 = trunc i8 %74 to i6
  store i6 %75, i6* %dst.addr.2.0.0.024_4, align 1
  %76 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %77 = load i8, i8* %76
  %78 = trunc i8 %77 to i6
  store i6 %78, i6* %dst.addr.3.0.0.032_4, align 1
  %79 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %80 = load i8, i8* %79
  %81 = trunc i8 %80 to i4
  store i4 %81, i4* %dst.addr.4.0.0.040_4, align 1
  %82 = load i32, i32* %src.addr.541, align 4
  store i32 %82, i32* %dst.addr.542_4, align 4
  %83 = bitcast i1* %src.addr.643 to i8*
  %84 = load i8, i8* %83
  %85 = trunc i8 %84 to i1
  store i1 %85, i1* %dst.addr.644_4, align 1
  br label %dst.addr.644.exit

dst.addr.644.case.5:                              ; preds = %for.loop
  store i20 %5, i20* %dst.addr.0.0.0.08_5, align 4
  %86 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %87 = load i24, i24* %86
  %88 = trunc i24 %87 to i20
  store i20 %88, i20* %dst.addr.1.0.0.016_5, align 4
  %89 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %90 = load i8, i8* %89
  %91 = trunc i8 %90 to i6
  store i6 %91, i6* %dst.addr.2.0.0.024_5, align 1
  %92 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %93 = load i8, i8* %92
  %94 = trunc i8 %93 to i6
  store i6 %94, i6* %dst.addr.3.0.0.032_5, align 1
  %95 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %96 = load i8, i8* %95
  %97 = trunc i8 %96 to i4
  store i4 %97, i4* %dst.addr.4.0.0.040_5, align 1
  %98 = load i32, i32* %src.addr.541, align 4
  store i32 %98, i32* %dst.addr.542_5, align 4
  %99 = bitcast i1* %src.addr.643 to i8*
  %100 = load i8, i8* %99
  %101 = trunc i8 %100 to i1
  store i1 %101, i1* %dst.addr.644_5, align 1
  br label %dst.addr.644.exit

dst.addr.644.case.6:                              ; preds = %for.loop
  store i20 %5, i20* %dst.addr.0.0.0.08_6, align 4
  %102 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %103 = load i24, i24* %102
  %104 = trunc i24 %103 to i20
  store i20 %104, i20* %dst.addr.1.0.0.016_6, align 4
  %105 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %106 = load i8, i8* %105
  %107 = trunc i8 %106 to i6
  store i6 %107, i6* %dst.addr.2.0.0.024_6, align 1
  %108 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %109 = load i8, i8* %108
  %110 = trunc i8 %109 to i6
  store i6 %110, i6* %dst.addr.3.0.0.032_6, align 1
  %111 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %112 = load i8, i8* %111
  %113 = trunc i8 %112 to i4
  store i4 %113, i4* %dst.addr.4.0.0.040_6, align 1
  %114 = load i32, i32* %src.addr.541, align 4
  store i32 %114, i32* %dst.addr.542_6, align 4
  %115 = bitcast i1* %src.addr.643 to i8*
  %116 = load i8, i8* %115
  %117 = trunc i8 %116 to i1
  store i1 %117, i1* %dst.addr.644_6, align 1
  br label %dst.addr.644.exit

dst.addr.644.case.7:                              ; preds = %for.loop
  %118 = icmp eq i64 %for.loop.idx46, 7
  call void @llvm.assume(i1 %118)
  store i20 %5, i20* %dst.addr.0.0.0.08_7, align 4
  %119 = bitcast i20* %src.addr.1.0.0.015 to i24*
  %120 = load i24, i24* %119
  %121 = trunc i24 %120 to i20
  store i20 %121, i20* %dst.addr.1.0.0.016_7, align 4
  %122 = bitcast i6* %src.addr.2.0.0.023 to i8*
  %123 = load i8, i8* %122
  %124 = trunc i8 %123 to i6
  store i6 %124, i6* %dst.addr.2.0.0.024_7, align 1
  %125 = bitcast i6* %src.addr.3.0.0.031 to i8*
  %126 = load i8, i8* %125
  %127 = trunc i8 %126 to i6
  store i6 %127, i6* %dst.addr.3.0.0.032_7, align 1
  %128 = bitcast i4* %src.addr.4.0.0.039 to i8*
  %129 = load i8, i8* %128
  %130 = trunc i8 %129 to i4
  store i4 %130, i4* %dst.addr.4.0.0.040_7, align 1
  %131 = load i32, i32* %src.addr.541, align 4
  store i32 %131, i32* %dst.addr.542_7, align 4
  %132 = bitcast i1* %src.addr.643 to i8*
  %133 = load i8, i8* %132
  %134 = trunc i8 %133 to i1
  store i1 %134, i1* %dst.addr.644_7, align 1
  br label %dst.addr.644.exit
...
; Function Attrs: argmemonly noinline willreturn
define internal void @copy_in(%"class.hls::stream<ap_uint<12>, 0>"* noalias "orig.arg.no"="0" "unpacked"="0", i12* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0", [8 x %struct.TriggerObject]* noalias readonly "orig.arg.no"="2" "unpacked"="2", i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.0" %_0, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.1" %_1, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.2" %_2, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.3" %_3, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.4" %_4, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.5" %_5, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.6" %_6, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.7" %_7, [8 x %struct.TriggerObject]* noalias readonly "orig.arg.no"="4" "unpacked"="4", i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.0" %_01, i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.1" %_12, i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.2" %_23, i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.3" %_34, i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.4" %_45, i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.5" %_56, i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.6" %_67, i89* noalias align 512 "orig.arg.no"="5" "unpacked"="5.7" %_78, %"struct.ap_uint<24>"* noalias readonly "orig.arg.no"="6" "unpacked"="6", i24* noalias nocapture align 512 "orig.arg.no"="7" "unpacked"="7.0", i32* noalias readonly "orig.arg.no"="8" "unpacked"="8", i32* noalias align 512 "orig.arg.no"="9" "unpacked"="9", i32* noalias readonly "orig.arg.no"="10" "unpacked"="10", i32* noalias align 512 "orig.arg.no"="11" "unpacked"="11") #7 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<12>, 0>.82"(i12* align 512 %1, %"class.hls::stream<ap_uint<12>, 0>"* %0)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.109.112(i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7, [8 x %struct.TriggerObject]* %2)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.109.112(i89* align 512 %_01, i89* align 512 %_12, i89* align 512 %_23, i89* align 512 %_34, i89* align 512 %_45, i89* align 512 %_56, i89* align 512 %_67, i89* align 512 %_78, [8 x %struct.TriggerObject]* %3)
...
; Function Attrs: argmemonly noinline willreturn
define internal void @copy_out(%"class.hls::stream<ap_uint<12>, 0>"* noalias "orig.arg.no"="0" "unpacked"="0", i12* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0", [8 x %struct.TriggerObject]* noalias "orig.arg.no"="2" "unpacked"="2", i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.0" %_0, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.1" %_1, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.2" %_2, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.3" %_3, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.4" %_4, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.5" %_5, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.6" %_6, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.7" %_7, [8 x %struct.TriggerObject]* noalias "orig.arg.no"="4" "unpacked"="4", i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.0" %_01, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.1" %_12, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.2" %_23, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.3" %_34, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.4" %_45, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.5" %_56, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.6" %_67, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.7" %_78, %"struct.ap_uint<24>"* noalias "orig.arg.no"="6" "unpacked"="6", i24* noalias nocapture readonly align 512 "orig.arg.no"="7" "unpacked"="7.0", i32* noalias "orig.arg.no"="8" "unpacked"="8", i32* noalias readonly align 512 "orig.arg.no"="9" "unpacked"="9", i32* noalias "orig.arg.no"="10" "unpacked"="10", i32* noalias readonly align 512 "orig.arg.no"="11" "unpacked"="11") #8 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<12>, 0>"(%"class.hls::stream<ap_uint<12>, 0>"* %0, i12* align 512 %1)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.123.126([8 x %struct.TriggerObject]* %2, i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.123.126([8 x %struct.TriggerObject]* %3, i89* align 512 %_01, i89* align 512 %_12, i89* align 512 %_23, i89* align 512 %_34, i89* align 512 %_45, i89* align 512 %_56, i89* align 512 %_67, i89* align 512 %_78)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>.73"(%"struct.ap_uint<24>"* %4, i24* align 512 %5)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a8struct.TriggerObject.109.112(i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.3" %dst_3, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.4" %dst_4, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.5" %dst_5, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.6" %dst_6, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.7" %dst_7, [8 x %struct.TriggerObject]* noalias readonly "orig.arg.no"="1" %src) #5 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a8struct.TriggerObject.110.111.148.155.182.189.216.223.250.257(i89* nonnull %dst_0, i89* %dst_1, i89* %dst_2, i89* %dst_3, i89* %dst_4, i89* %dst_5, i89* %dst_6, i89* %dst_7, [8 x %struct.TriggerObject]* nonnull %src, i64 8)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8struct.TriggerObject.110.111.148.155.182.189.216.223.250.257(i89* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i89* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i89* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, i89* "orig.arg.no"="0" "unpacked"="0.3" %dst_3, i89* "orig.arg.no"="0" "unpacked"="0.4" %dst_4, i89* "orig.arg.no"="0" "unpacked"="0.5" %dst_5, i89* "orig.arg.no"="0" "unpacked"="0.6" %dst_6, i89* "orig.arg.no"="0" "unpacked"="0.7" %dst_7, [8 x %struct.TriggerObject]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #4 {
entry:
  %0 = icmp eq [8 x %struct.TriggerObject]* %src, null
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a8struct.TriggerObject.123.126([8 x %struct.TriggerObject]* noalias "orig.arg.no"="0" %dst, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %src_3, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.4" %src_4, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.5" %src_5, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.6" %src_6, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.7" %src_7) #5 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a8struct.TriggerObject.124.125.138.165.172.199.206.233.240.267([8 x %struct.TriggerObject]* nonnull %dst, i89* nonnull %src_0, i89* %src_1, i89* %src_2, i89* %src_3, i89* %src_4, i89* %src_5, i89* %src_6, i89* %src_7, i64 8)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8struct.TriggerObject.124.125.138.165.172.199.206.233.240.267([8 x %struct.TriggerObject]* "orig.arg.no"="0" %dst, i89* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, i89* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, i89* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, i89* readonly "orig.arg.no"="1" "unpacked"="1.3" %src_3, i89* readonly "orig.arg.no"="1" "unpacked"="1.4" %src_4, i89* readonly "orig.arg.no"="1" "unpacked"="1.5" %src_5, i89* readonly "orig.arg.no"="1" "unpacked"="1.6" %src_6, i89* readonly "orig.arg.no"="1" "unpacked"="1.7" %src_7, i64 "orig.arg.no"="2" %num) #4 {
entry:
...
declare void @apatb_calo_trigger_tower_stream_ref_hw(i12*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i24*, i32*, i32*)

; Function Attrs: argmemonly noinline willreturn
define internal void @copy_back(%"class.hls::stream<ap_uint<12>, 0>"* noalias "orig.arg.no"="0" "unpacked"="0", i12* noalias nocapture align 512 "orig.arg.no"="1" "unpacked"="1.0", [8 x %struct.TriggerObject]* noalias "orig.arg.no"="2" "unpacked"="2", i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.0" %_0, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.1" %_1, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.2" %_2, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.3" %_3, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.4" %_4, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.5" %_5, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.6" %_6, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.7" %_7, [8 x %struct.TriggerObject]* noalias "orig.arg.no"="4" "unpacked"="4", i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.0" %_01, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.1" %_12, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.2" %_23, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.3" %_34, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.4" %_45, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.5" %_56, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.6" %_67, i89* noalias readonly align 512 "orig.arg.no"="5" "unpacked"="5.7" %_78, %"struct.ap_uint<24>"* noalias "orig.arg.no"="6" "unpacked"="6", i24* noalias nocapture readonly align 512 "orig.arg.no"="7" "unpacked"="7.0", i32* noalias "orig.arg.no"="8" "unpacked"="8", i32* noalias readonly align 512 "orig.arg.no"="9" "unpacked"="9", i32* noalias "orig.arg.no"="10" "unpacked"="10", i32* noalias readonly align 512 "orig.arg.no"="11" "unpacked"="11") #8 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<ap_uint<12>, 0>"(%"class.hls::stream<ap_uint<12>, 0>"* %0, i12* align 512 %1)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.123.126([8 x %struct.TriggerObject]* %2, i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.123.126([8 x %struct.TriggerObject]* %3, i89* align 512 %_01, i89* align 512 %_12, i89* align 512 %_23, i89* align 512 %_34, i89* align 512 %_45, i89* align 512 %_56, i89* align 512 %_67, i89* align 512 %_78)
...
define void @calo_trigger_tower_stream_ref_hw_stub_wrapper(i12*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i24*, i32*, i32*) #9 {
entry:
  %24 = alloca %"class.hls::stream<ap_uint<12>, 0>"
  %25 = alloca [8 x %struct.TriggerObject]
  %26 = alloca [8 x %struct.TriggerObject]
  %27 = alloca %"struct.ap_uint<24>"
  call void @copy_out(%"class.hls::stream<ap_uint<12>, 0>"* %24, i12* %0, [8 x %struct.TriggerObject]* %25, i89* %5, i89* %6, i89* %7, i89* %8, i89* %9, i89* %10, i89* %11, i89* %12, [8 x %struct.TriggerObject]* %26, i89* %13, i89* %14, i89* %15, i89* %16, i89* %17, i89* %18, i89* %19, i89* %20, %"struct.ap_uint<24>"* %27, i24* %21, i32* null, i32* %22, i32* null, i32* %23)
  %28 = bitcast [8 x %struct.TriggerObject]* %25 to %struct.TriggerObject*
  %29 = bitcast [8 x %struct.TriggerObject]* %26 to %struct.TriggerObject*
  call void @calo_trigger_tower_stream_ref_hw_stub(%"class.hls::stream<ap_uint<12>, 0>"* %24, %"struct.ap_uint<12>"* %1, %"struct.ap_uint<20>"* %2, %"struct.ap_uint<12>"* %3, %"struct.ap_uint<20>"* %4, %struct.TriggerObject* %28, %struct.TriggerObject* %29, %"struct.ap_uint<24>"* %27, i32* %22, i32* %23)
  call void @copy_in(%"class.hls::stream<ap_uint<12>, 0>"* %24, i12* %0, [8 x %struct.TriggerObject]* %25, i89* %5, i89* %6, i89* %7, i89* %8, i89* %9, i89* %10, i89* %11, i89* %12, [8 x %struct.TriggerObject]* %26, i89* %13, i89* %14, i89* %15, i89* %16, i89* %17, i89* %18, i89* %19, i89* %20, %"struct.ap_uint<24>"* %27, i24* %21, i32* null, i32* %22, i32* null, i32* %23)
  ret void
}

declare void @calo_trigger_tower_stream_ref_hw_stub(%"class.hls::stream<ap_uint<12>, 0>"* noalias nocapture nonnull, %"struct.ap_uint<12>"* nocapture readonly, %"struct.ap_uint<20>"* nocapture readonly, %"struct.ap_uint<12>"* nocapture readonly, %"struct.ap_uint<20>"* nocapture readonly, %struct.TriggerObject* noalias nocapture nonnull, %struct.TriggerObject* noalias nocapture nonnull, %"struct.ap_uint<24>"* noalias nocapture nonnull, i32* noalias nocapture nonnull, i32* noalias nocapture nonnull)
