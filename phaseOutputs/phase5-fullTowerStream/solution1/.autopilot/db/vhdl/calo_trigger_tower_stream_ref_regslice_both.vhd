...
entity calo_trigger_tower_stream_ref_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity calo_trigger_tower_stream_ref_regslice_both;

architecture behave of calo_trigger_tower_stream_ref_regslice_both is
