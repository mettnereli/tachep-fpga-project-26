set moduleName select_top_n_from_stream_fixed_1440_1
set isTopModule 0
...
set C_modelName {select_top_n_from_stream_fixed<1440>.1}
set C_modelType { int 456 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ jet_cluster_stream int 61 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "jet_cluster_stream", "interface" : "fifo", "bitwidth" : 61, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ jet_cluster_stream_dout sc_in sc_lv 61 signal 0 } 
	{ jet_cluster_stream_num_data_valid sc_in sc_lv 7 signal 0 } 
	{ jet_cluster_stream_fifo_cap sc_in sc_lv 7 signal 0 } 
	{ jet_cluster_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ jet_cluster_stream_read sc_out sc_logic 1 signal 0 } 
	{ num_jet_clusters sc_out sc_lv 32 signal 1 } 
	{ num_jet_clusters_ap_vld sc_out sc_logic 1 outvld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "jet_cluster_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":61, "type": "signal", "bundle":{"name": "jet_cluster_stream", "role": "dout" }} , 
 	...
 	{ "name": "jet_cluster_stream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "jet_cluster_stream", "role": "empty_n" }} , 
 	{ "name": "jet_cluster_stream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "jet_cluster_stream", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "jet_cluster_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_15_3_20_1_1_U112", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_15_3_20_1_1_U113", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_15_3_6_1_1_U114", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_15_3_6_1_1_U115", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_15_3_4_1_1_U116", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_15_3_1_1_1_U117", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	jet_cluster_stream { ap_fifo {  { jet_cluster_stream_dout fifo_data_in 0 61 }  { jet_cluster_stream_num_data_valid fifo_status_num_data_valid 0 7 }  { jet_cluster_stream_fifo_cap fifo_update 0 7 }  { jet_cluster_stream_empty_n fifo_status 0 1 }  { jet_cluster_stream_read fifo_port_we 1 1 } } }
