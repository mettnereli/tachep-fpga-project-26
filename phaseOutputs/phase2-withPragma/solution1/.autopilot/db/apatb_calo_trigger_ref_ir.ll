...
define void @apatb_calo_trigger_ref_ir([60 x %"struct.ap_uint<12>"]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="30" %grid, %"struct.ap_uint<12>"* nocapture readonly %seed_threshold, %"struct.ap_uint<20>"* nocapture readonly %cluster_threshold, %struct.TriggerObject* noalias nocapture nonnull "fpga.decayed.dim.hint"="8" "partition" %objects, %"struct.ap_uint<24>"* noalias nocapture nonnull %ht, i32* noalias nocapture nonnull %num_clusters) local_unnamed_addr #0 {
entry:
  %grid_copy = alloca [30 x [60 x i12]], align 512
  %objects_copy_0 = alloca i89, align 512
  %objects_copy_1 = alloca i89, align 512
  %objects_copy_2 = alloca i89, align 512
  %objects_copy_3 = alloca i89, align 512
  %objects_copy_4 = alloca i89, align 512
  %objects_copy_5 = alloca i89, align 512
  %objects_copy_6 = alloca i89, align 512
  %objects_copy_7 = alloca i89, align 512
  ...
  call void @copy_in([30 x [60 x %"struct.ap_uint<12>"]]* nonnull %0, [30 x [60 x i12]]* nonnull align 512 %grid_copy, [8 x %struct.TriggerObject]* nonnull %1, i89* nonnull align 512 %objects_copy_0, i89* nonnull align 512 %objects_copy_1, i89* nonnull align 512 %objects_copy_2, i89* nonnull align 512 %objects_copy_3, i89* nonnull align 512 %objects_copy_4, i89* nonnull align 512 %objects_copy_5, i89* nonnull align 512 %objects_copy_6, i89* nonnull align 512 %objects_copy_7, %"struct.ap_uint<24>"* nonnull %ht, i24* nonnull align 512 %ht_copy, i32* nonnull %num_clusters, i32* nonnull align 512 %num_clusters_copy)
  call void @apatb_calo_trigger_ref_hw([30 x [60 x i12]]* %grid_copy, %"struct.ap_uint<12>"* %seed_threshold, %"struct.ap_uint<20>"* %cluster_threshold, i89* %objects_copy_0, i89* %objects_copy_1, i89* %objects_copy_2, i89* %objects_copy_3, i89* %objects_copy_4, i89* %objects_copy_5, i89* %objects_copy_6, i89* %objects_copy_7, i24* %ht_copy, i32* %num_clusters_copy)
  call void @copy_back([30 x [60 x %"struct.ap_uint<12>"]]* %0, [30 x [60 x i12]]* %grid_copy, [8 x %struct.TriggerObject]* %1, i89* %objects_copy_0, i89* %objects_copy_1, i89* %objects_copy_2, i89* %objects_copy_3, i89* %objects_copy_4, i89* %objects_copy_5, i89* %objects_copy_6, i89* %objects_copy_7, %"struct.ap_uint<24>"* %ht, i24* %ht_copy, i32* %num_clusters, i32* %num_clusters_copy)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>.66"(%"struct.ap_uint<24>"* noalias "unpacked"="0" %dst, i24* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8struct.TriggerObject.80.81(i89* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i89* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i89* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, i89* "orig.arg.no"="0" "unpacked"="0.3" %dst_3, i89* "orig.arg.no"="0" "unpacked"="0.4" %dst_4, i89* "orig.arg.no"="0" "unpacked"="0.5" %dst_5, i89* "orig.arg.no"="0" "unpacked"="0.6" %dst_6, i89* "orig.arg.no"="0" "unpacked"="0.7" %dst_7, [8 x %struct.TriggerObject]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #2 {
entry:
  %0 = icmp eq [8 x %struct.TriggerObject]* %src, null
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a8struct.TriggerObject.79.82(i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.3" %dst_3, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.4" %dst_4, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.5" %dst_5, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.6" %dst_6, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.7" %dst_7, [8 x %struct.TriggerObject]* noalias readonly "orig.arg.no"="1" %src) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a8struct.TriggerObject.80.81(i89* nonnull %dst_0, i89* %dst_1, i89* %dst_2, i89* %dst_3, i89* %dst_4, i89* %dst_5, i89* %dst_6, i89* %dst_7, [8 x %struct.TriggerObject]* nonnull %src, i64 8)
  br label %ret
...
entry:
  ...
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.79.82(i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7, [8 x %struct.TriggerObject]* %2)
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8struct.TriggerObject.90.91([8 x %struct.TriggerObject]* "orig.arg.no"="0" %dst, i89* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, i89* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, i89* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, i89* readonly "orig.arg.no"="1" "unpacked"="1.3" %src_3, i89* readonly "orig.arg.no"="1" "unpacked"="1.4" %src_4, i89* readonly "orig.arg.no"="1" "unpacked"="1.5" %src_5, i89* readonly "orig.arg.no"="1" "unpacked"="1.6" %src_6, i89* readonly "orig.arg.no"="1" "unpacked"="1.7" %src_7, i64 "orig.arg.no"="2" %num) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a8struct.TriggerObject.89.92([8 x %struct.TriggerObject]* noalias "orig.arg.no"="0" %dst, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %src_3, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.4" %src_4, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.5" %src_5, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.6" %src_6, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.7" %src_7) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a8struct.TriggerObject.90.91([8 x %struct.TriggerObject]* nonnull %dst, i89* nonnull %src_0, i89* %src_1, i89* %src_2, i89* %src_3, i89* %src_4, i89* %src_5, i89* %src_6, i89* %src_7, i64 8)
  br label %ret
...
entry:
  call fastcc void @"onebyonecpy_hls.p0a30a60struct.ap_uint<12>.161"([30 x [60 x %"struct.ap_uint<12>"]]* %0, [30 x [60 x i12]]* align 512 %1)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.89.92([8 x %struct.TriggerObject]* %2, i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>.66"(%"struct.ap_uint<24>"* %3, i24* align 512 %4)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %5, i32* align 512 %6)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a30a60struct.ap_uint<12>.161"([30 x [60 x %"struct.ap_uint<12>"]]* noalias %dst, [30 x [60 x i12]]* noalias readonly align 512 %src) unnamed_addr #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a30a60struct.ap_uint<12>.164"([30 x [60 x %"struct.ap_uint<12>"]]* nonnull %dst, [30 x [60 x i12]]* nonnull %src, i64 30)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a30a60struct.ap_uint<12>.164"([30 x [60 x %"struct.ap_uint<12>"]]* %dst, [30 x [60 x i12]]* readonly %src, i64 %num) local_unnamed_addr #2 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a60struct.ap_uint<12>.167"([60 x %"struct.ap_uint<12>"]* %dst.addr, [60 x i12]* %3, i64 60)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a60struct.ap_uint<12>.167"([60 x %"struct.ap_uint<12>"]* %dst, [60 x i12]* readonly %src, i64 %num) local_unnamed_addr #2 {
entry:
...
declare void @apatb_calo_trigger_ref_hw([30 x [60 x i12]]*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i24*, i32*)
...
define void @calo_trigger_ref_hw_stub_wrapper([30 x [60 x i12]]*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i24*, i32*) #6 {
entry:
  ...
  call void @calo_trigger_ref_hw_stub([60 x %"struct.ap_uint<12>"]* %16, %"struct.ap_uint<12>"* %1, %"struct.ap_uint<20>"* %2, %struct.TriggerObject* %17, %"struct.ap_uint<24>"* %15, i32* %12)
