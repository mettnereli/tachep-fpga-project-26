...
// 
// ==============================================================
#ifndef XCALO_TRIGGER_REF_H
#define XCALO_TRIGGER_REF_H
...
#include <stddef.h>
#endif
#include "xcalo_trigger_ref_hw.h"
...
#ifndef __linux__
#define XCalo_trigger_ref_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XCalo_trigger_ref_ReadReg(BaseAddress, RegOffset) \
...
#else
int XCalo_trigger_ref_Initialize(XCalo_trigger_ref *InstancePtr, const char* InstanceName);
int XCalo_trigger_ref_Release(XCalo_trigger_ref *InstancePtr);
#endif
