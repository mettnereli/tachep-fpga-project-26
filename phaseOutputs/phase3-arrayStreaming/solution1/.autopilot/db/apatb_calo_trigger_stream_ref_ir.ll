...
define void @apatb_calo_trigger_stream_ref_ir([60 x %"struct.ap_uint<12>"]* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="30" %towers, %"struct.ap_uint<12>"* nocapture readonly %seed_threshold, %"struct.ap_uint<20>"* nocapture readonly %cluster_threshold, %struct.TriggerObject* noalias nocapture nonnull "fpga.decayed.dim.hint"="8" "partition" %trigger_objects, %"struct.ap_uint<24>"* noalias nocapture nonnull %ht, i32* noalias nocapture nonnull %num_clusters) local_unnamed_addr #0 {
entry:
  %towers_copy = alloca [30 x [60 x i12]], align 512
  %trigger_objects_copy_0 = alloca i89, align 512
  %trigger_objects_copy_1 = alloca i89, align 512
  %trigger_objects_copy_2 = alloca i89, align 512
  %trigger_objects_copy_3 = alloca i89, align 512
  %trigger_objects_copy_4 = alloca i89, align 512
  %trigger_objects_copy_5 = alloca i89, align 512
  %trigger_objects_copy_6 = alloca i89, align 512
  %trigger_objects_copy_7 = alloca i89, align 512
  ...
  %1 = bitcast %struct.TriggerObject* %trigger_objects to [8 x %struct.TriggerObject]*
  call void @copy_in([30 x [60 x %"struct.ap_uint<12>"]]* nonnull %0, [30 x [60 x i12]]* nonnull align 512 %towers_copy, [8 x %struct.TriggerObject]* nonnull %1, i89* nonnull align 512 %trigger_objects_copy_0, i89* nonnull align 512 %trigger_objects_copy_1, i89* nonnull align 512 %trigger_objects_copy_2, i89* nonnull align 512 %trigger_objects_copy_3, i89* nonnull align 512 %trigger_objects_copy_4, i89* nonnull align 512 %trigger_objects_copy_5, i89* nonnull align 512 %trigger_objects_copy_6, i89* nonnull align 512 %trigger_objects_copy_7, %"struct.ap_uint<24>"* nonnull %ht, i24* nonnull align 512 %ht_copy, i32* nonnull %num_clusters, i32* nonnull align 512 %num_clusters_copy)
  call void @apatb_calo_trigger_stream_ref_hw([30 x [60 x i12]]* %towers_copy, %"struct.ap_uint<12>"* %seed_threshold, %"struct.ap_uint<20>"* %cluster_threshold, i89* %trigger_objects_copy_0, i89* %trigger_objects_copy_1, i89* %trigger_objects_copy_2, i89* %trigger_objects_copy_3, i89* %trigger_objects_copy_4, i89* %trigger_objects_copy_5, i89* %trigger_objects_copy_6, i89* %trigger_objects_copy_7, i24* %ht_copy, i32* %num_clusters_copy)
  call void @copy_back([30 x [60 x %"struct.ap_uint<12>"]]* %0, [30 x [60 x i12]]* %towers_copy, [8 x %struct.TriggerObject]* %1, i89* %trigger_objects_copy_0, i89* %trigger_objects_copy_1, i89* %trigger_objects_copy_2, i89* %trigger_objects_copy_3, i89* %trigger_objects_copy_4, i89* %trigger_objects_copy_5, i89* %trigger_objects_copy_6, i89* %trigger_objects_copy_7, %"struct.ap_uint<24>"* %ht, i24* %ht_copy, i32* %num_clusters, i32* %num_clusters_copy)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>.32"(%"struct.ap_uint<24>"* noalias "unpacked"="0" %dst, i24* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8struct.TriggerObject.48.49(i89* "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i89* "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i89* "orig.arg.no"="0" "unpacked"="0.2" %dst_2, i89* "orig.arg.no"="0" "unpacked"="0.3" %dst_3, i89* "orig.arg.no"="0" "unpacked"="0.4" %dst_4, i89* "orig.arg.no"="0" "unpacked"="0.5" %dst_5, i89* "orig.arg.no"="0" "unpacked"="0.6" %dst_6, i89* "orig.arg.no"="0" "unpacked"="0.7" %dst_7, [8 x %struct.TriggerObject]* readonly "orig.arg.no"="1" %src, i64 "orig.arg.no"="2" %num) #2 {
entry:
  %0 = icmp eq [8 x %struct.TriggerObject]* %src, null
...
dst.addr.644.case.1:                              ; preds = %for.loop
  ...
  %53 = shl i89 %52, 20
  %54 = and i89 %.partset42, -1099510579201
  %.partset43 = or i89 %54, %53
  ...
  %59 = shl i89 %58, 40
  %60 = and i89 %.partset43, -69269232549889
  %.partset44 = or i89 %60, %59
  ...
  %65 = shl i89 %64, 46
  %66 = and i89 %.partset44, -4433230883192833
  ...
  %81 = shl i89 %80, 88
  %82 = and i89 %.partset47, 309485009821345068724781055
  %.partset48 = or i89 %82, %81
...
dst.addr.644.case.3:                              ; preds = %for.loop
  ...
  %129 = shl i89 %128, 20
  %130 = and i89 %.partset28, -1099510579201
  %.partset29 = or i89 %130, %129
  ...
  %135 = shl i89 %134, 40
  %136 = and i89 %.partset29, -69269232549889
  %.partset30 = or i89 %136, %135
  ...
  %141 = shl i89 %140, 46
  %142 = and i89 %.partset30, -4433230883192833
  ...
  %157 = shl i89 %156, 88
  %158 = and i89 %.partset33, 309485009821345068724781055
  %.partset34 = or i89 %158, %157
...
dst.addr.644.case.5:                              ; preds = %for.loop
  ...
  %205 = shl i89 %204, 20
  %206 = and i89 %.partset14, -1099510579201
  %.partset15 = or i89 %206, %205
  ...
  %211 = shl i89 %210, 40
  %212 = and i89 %.partset15, -69269232549889
  %.partset16 = or i89 %212, %211
  ...
  %217 = shl i89 %216, 46
  %218 = and i89 %.partset16, -4433230883192833
  ...
  %233 = shl i89 %232, 88
  %234 = and i89 %.partset19, 309485009821345068724781055
  %.partset20 = or i89 %234, %233
...
dst.addr.644.case.7:                              ; preds = %for.loop
  ...
  %282 = shl i89 %281, 20
  %283 = and i89 %.partset, -1099510579201
  %.partset1 = or i89 %283, %282
  ...
  %288 = shl i89 %287, 40
  %289 = and i89 %.partset1, -69269232549889
  %.partset2 = or i89 %289, %288
  ...
  %294 = shl i89 %293, 46
  %295 = and i89 %.partset2, -4433230883192833
  ...
  %310 = shl i89 %309, 88
  %311 = and i89 %.partset5, 309485009821345068724781055
  %.partset6 = or i89 %311, %310
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a8struct.TriggerObject.47.50(i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.0" %dst_0, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.1" %dst_1, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.2" %dst_2, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.3" %dst_3, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.4" %dst_4, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.5" %dst_5, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.6" %dst_6, i89* noalias align 512 "orig.arg.no"="0" "unpacked"="0.7" %dst_7, [8 x %struct.TriggerObject]* noalias readonly "orig.arg.no"="1" %src) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a8struct.TriggerObject.48.49(i89* nonnull %dst_0, i89* %dst_1, i89* %dst_2, i89* %dst_3, i89* %dst_4, i89* %dst_5, i89* %dst_6, i89* %dst_7, [8 x %struct.TriggerObject]* nonnull %src, i64 8)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_in([30 x [60 x %"struct.ap_uint<12>"]]* noalias readonly "orig.arg.no"="0" "unpacked"="0", [30 x [60 x i12]]* noalias align 512 "orig.arg.no"="1" "unpacked"="1", [8 x %struct.TriggerObject]* noalias readonly "orig.arg.no"="2" "unpacked"="2", i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.0" %_0, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.1" %_1, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.2" %_2, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.3" %_3, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.4" %_4, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.5" %_5, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.6" %_6, i89* noalias align 512 "orig.arg.no"="3" "unpacked"="3.7" %_7, %"struct.ap_uint<24>"* noalias readonly "orig.arg.no"="4" "unpacked"="4", i24* noalias nocapture align 512 "orig.arg.no"="5" "unpacked"="5.0", i32* noalias readonly "orig.arg.no"="6" "unpacked"="6", i32* noalias align 512 "orig.arg.no"="7" "unpacked"="7") #4 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a30a60struct.ap_uint<12>"([30 x [60 x i12]]* align 512 %1, [30 x [60 x %"struct.ap_uint<12>"]]* %0)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.47.50(i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7, [8 x %struct.TriggerObject]* %2)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>"(i24* align 512 %4, %"struct.ap_uint<24>"* %3)
  call fastcc void @onebyonecpy_hls.p0i32(i32* align 512 %6, i32* %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define void @arraycpy_hls.p0a8struct.TriggerObject.60.61([8 x %struct.TriggerObject]* "orig.arg.no"="0" %dst, i89* readonly "orig.arg.no"="1" "unpacked"="1.0" %src_0, i89* readonly "orig.arg.no"="1" "unpacked"="1.1" %src_1, i89* readonly "orig.arg.no"="1" "unpacked"="1.2" %src_2, i89* readonly "orig.arg.no"="1" "unpacked"="1.3" %src_3, i89* readonly "orig.arg.no"="1" "unpacked"="1.4" %src_4, i89* readonly "orig.arg.no"="1" "unpacked"="1.5" %src_5, i89* readonly "orig.arg.no"="1" "unpacked"="1.6" %src_6, i89* readonly "orig.arg.no"="1" "unpacked"="1.7" %src_7, i64 "orig.arg.no"="2" %num) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @onebyonecpy_hls.p0a8struct.TriggerObject.59.62([8 x %struct.TriggerObject]* noalias "orig.arg.no"="0" %dst, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src_0, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.1" %src_1, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.2" %src_2, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.3" %src_3, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.4" %src_4, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.5" %src_5, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.6" %src_6, i89* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1.7" %src_7) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @arraycpy_hls.p0a8struct.TriggerObject.60.61([8 x %struct.TriggerObject]* nonnull %dst, i89* nonnull %src_0, i89* %src_1, i89* %src_2, i89* %src_3, i89* %src_4, i89* %src_5, i89* %src_6, i89* %src_7, i64 8)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_out([30 x [60 x %"struct.ap_uint<12>"]]* noalias "orig.arg.no"="0" "unpacked"="0", [30 x [60 x i12]]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1", [8 x %struct.TriggerObject]* noalias "orig.arg.no"="2" "unpacked"="2", i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.0" %_0, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.1" %_1, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.2" %_2, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.3" %_3, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.4" %_4, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.5" %_5, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.6" %_6, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.7" %_7, %"struct.ap_uint<24>"* noalias "orig.arg.no"="4" "unpacked"="4", i24* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0", i32* noalias "orig.arg.no"="6" "unpacked"="6", i32* noalias readonly align 512 "orig.arg.no"="7" "unpacked"="7") #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0a30a60struct.ap_uint<12>.142"([30 x [60 x %"struct.ap_uint<12>"]]* %0, [30 x [60 x i12]]* align 512 %1)
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.59.62([8 x %struct.TriggerObject]* %2, i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>.32"(%"struct.ap_uint<24>"* %3, i24* align 512 %4)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %5, i32* align 512 %6)
  ret void
}

; Function Attrs: argmemonly noinline norecurse willreturn
define internal fastcc void @"onebyonecpy_hls.p0a30a60struct.ap_uint<12>.142"([30 x [60 x %"struct.ap_uint<12>"]]* noalias %dst, [30 x [60 x i12]]* noalias readonly align 512 %src) unnamed_addr #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a30a60struct.ap_uint<12>.145"([30 x [60 x %"struct.ap_uint<12>"]]* nonnull %dst, [30 x [60 x i12]]* nonnull %src, i64 30)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a30a60struct.ap_uint<12>.145"([30 x [60 x %"struct.ap_uint<12>"]]* %dst, [30 x [60 x i12]]* readonly %src, i64 %num) local_unnamed_addr #2 {
entry:
...
for.loop:                                         ; preds = %for.loop, %for.loop.lr.ph
  ...
  call void @"arraycpy_hls.p0a60struct.ap_uint<12>.148"([60 x %"struct.ap_uint<12>"]* %dst.addr, [60 x i12]* %3, i64 60)
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx2, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, %num
  br i1 %exitcond, label %for.loop, label %copy.split
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a60struct.ap_uint<12>.148"([60 x %"struct.ap_uint<12>"]* %dst, [60 x i12]* readonly %src, i64 %num) local_unnamed_addr #2 {
entry:
...
declare void @apatb_calo_trigger_stream_ref_hw([30 x [60 x i12]]*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i24*, i32*)

; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @copy_back([30 x [60 x %"struct.ap_uint<12>"]]* noalias "orig.arg.no"="0" "unpacked"="0", [30 x [60 x i12]]* noalias readonly align 512 "orig.arg.no"="1" "unpacked"="1", [8 x %struct.TriggerObject]* noalias "orig.arg.no"="2" "unpacked"="2", i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.0" %_0, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.1" %_1, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.2" %_2, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.3" %_3, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.4" %_4, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.5" %_5, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.6" %_6, i89* noalias readonly align 512 "orig.arg.no"="3" "unpacked"="3.7" %_7, %"struct.ap_uint<24>"* noalias "orig.arg.no"="4" "unpacked"="4", i24* noalias nocapture readonly align 512 "orig.arg.no"="5" "unpacked"="5.0", i32* noalias "orig.arg.no"="6" "unpacked"="6", i32* noalias readonly align 512 "orig.arg.no"="7" "unpacked"="7") #5 {
entry:
  call void @onebyonecpy_hls.p0a8struct.TriggerObject.59.62([8 x %struct.TriggerObject]* %2, i89* align 512 %_0, i89* align 512 %_1, i89* align 512 %_2, i89* align 512 %_3, i89* align 512 %_4, i89* align 512 %_5, i89* align 512 %_6, i89* align 512 %_7)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<24>.32"(%"struct.ap_uint<24>"* %3, i24* align 512 %4)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %5, i32* align 512 %6)
...
define void @calo_trigger_stream_ref_hw_stub_wrapper([30 x [60 x i12]]*, %"struct.ap_uint<12>"*, %"struct.ap_uint<20>"*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i89*, i24*, i32*) #6 {
entry:
  %13 = alloca [30 x [60 x %"struct.ap_uint<12>"]]
  %14 = alloca [8 x %struct.TriggerObject]
  %15 = alloca %"struct.ap_uint<24>"
  call void @copy_out([30 x [60 x %"struct.ap_uint<12>"]]* %13, [30 x [60 x i12]]* %0, [8 x %struct.TriggerObject]* %14, i89* %3, i89* %4, i89* %5, i89* %6, i89* %7, i89* %8, i89* %9, i89* %10, %"struct.ap_uint<24>"* %15, i24* %11, i32* null, i32* %12)
  %16 = bitcast [30 x [60 x %"struct.ap_uint<12>"]]* %13 to [60 x %"struct.ap_uint<12>"]*
  %17 = bitcast [8 x %struct.TriggerObject]* %14 to %struct.TriggerObject*
  call void @calo_trigger_stream_ref_hw_stub([60 x %"struct.ap_uint<12>"]* %16, %"struct.ap_uint<12>"* %1, %"struct.ap_uint<20>"* %2, %struct.TriggerObject* %17, %"struct.ap_uint<24>"* %15, i32* %12)
  call void @copy_in([30 x [60 x %"struct.ap_uint<12>"]]* %13, [30 x [60 x i12]]* %0, [8 x %struct.TriggerObject]* %14, i89* %3, i89* %4, i89* %5, i89* %6, i89* %7, i89* %8, i89* %9, i89* %10, %"struct.ap_uint<24>"* %15, i24* %11, i32* null, i32* %12)
  ret void
}

declare void @calo_trigger_stream_ref_hw_stub([60 x %"struct.ap_uint<12>"]* noalias nocapture nonnull readonly, %"struct.ap_uint<12>"* nocapture readonly, %"struct.ap_uint<20>"* nocapture readonly, %struct.TriggerObject* noalias nocapture nonnull, %"struct.ap_uint<24>"* noalias nocapture nonnull, i32* noalias nocapture nonnull)
...
!5 = !{!6, !8, !10}
!6 = !{!7}
!7 = !{!"3", [8 x %struct.TriggerObject]* null}
!8 = !{!9}
!9 = !{!"array_partition", !"type=Complete", !"dim=1"}
!10 = !{!11, !12, !13, !14, !15, !16, !17, !18}
!11 = !{!"3.0", %struct.TriggerObject* null}
!12 = !{!"3.1", %struct.TriggerObject* null}
!13 = !{!"3.2", %struct.TriggerObject* null}
!14 = !{!"3.3", %struct.TriggerObject* null}
!15 = !{!"3.4", %struct.TriggerObject* null}
!16 = !{!"3.5", %struct.TriggerObject* null}
!17 = !{!"3.6", %struct.TriggerObject* null}
!18 = !{!"3.7", %struct.TriggerObject* null}
