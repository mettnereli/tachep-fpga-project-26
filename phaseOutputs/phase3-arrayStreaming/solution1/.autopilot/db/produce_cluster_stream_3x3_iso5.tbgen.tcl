set moduleName produce_cluster_stream_3x3_iso5
set isTopModule 0
...
set C_modelName {produce_cluster_stream_3x3_iso5}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "towers", "Type" : "Bram", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_find_clusters_stream_3_5_s_fu_38", "Port" : "towers", "Inst_start_state" : "1", "Inst_end_state" : "2"}]},
			{"Name" : "seed_threshold", "Type" : "None", "Direction" : "I"},
			{"Name" : "cluster_threshold", "Type" : "None", "Direction" : "I"},
			{"Name" : "cluster_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "64", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_find_clusters_stream_3_5_s_fu_38", "Port" : "cluster_stream", "Inst_start_state" : "1", "Inst_end_state" : "2"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_find_clusters_stream_3_5_s_fu_38", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_find_clusters_stream_3_5_s_fu_38.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "20283", "Max" : "20283"}
]}
