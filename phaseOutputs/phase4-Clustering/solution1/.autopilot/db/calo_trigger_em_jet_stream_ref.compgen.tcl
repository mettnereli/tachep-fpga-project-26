...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 261 \
			corename calo_trigger_em_jet_stream_ref_CTRL_axilite \
			name calo_trigger_em_jet_stream_ref_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler calo_trigger_em_jet_stream_ref_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
