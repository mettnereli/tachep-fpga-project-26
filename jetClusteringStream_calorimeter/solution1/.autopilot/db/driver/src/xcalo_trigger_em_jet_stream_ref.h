...
// 
// ==============================================================
#ifndef XCALO_TRIGGER_EM_JET_STREAM_REF_H
#define XCALO_TRIGGER_EM_JET_STREAM_REF_H
...
#include <stddef.h>
#endif
#include "xcalo_trigger_em_jet_stream_ref_hw.h"
...
} XCalo_trigger_em_jet_stream_ref_Config;
#endif

typedef struct {
    u64 Ctrl_BaseAddress;
    u32 IsReady;
} XCalo_trigger_em_jet_stream_ref;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XCalo_trigger_em_jet_stream_ref_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XCalo_trigger_em_jet_stream_ref_ReadReg(BaseAddress, RegOffset) \
...
#else
int XCalo_trigger_em_jet_stream_ref_Initialize(XCalo_trigger_em_jet_stream_ref *InstancePtr, const char* InstanceName);
int XCalo_trigger_em_jet_stream_ref_Release(XCalo_trigger_em_jet_stream_ref *InstancePtr);
#endif
