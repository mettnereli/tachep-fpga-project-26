set moduleName produce_em_cluster_stream
set isTopModule 0
...
set C_modelName {produce_em_cluster_stream}
...
set C_modelArgList {
	{ towers int 12 regular {bram 1800 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ em_cluster_stream_din sc_out sc_lv 61 signal 3 } 
	{ em_cluster_stream_num_data_valid sc_in sc_lv 7 signal 3 } 
	{ em_cluster_stream_fifo_cap sc_in sc_lv 7 signal 3 } 
	{ em_cluster_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ em_cluster_stream_write sc_out sc_logic 1 signal 3 } 
...
set Spec2ImplPortList { 
	towers { bram {  { towers_Addr_A MemPortADDR2 1 32 }  { towers_EN_A MemPortCE2 1 1 }  { towers_WEN_A MemPortWE2 1 2 }  { towers_Din_A MemPortDIN2 1 16 }  { towers_Dout_A MemPortDOUT2 0 16 } } }
