...
entity calo_trigger_em_jet_stream_ref_fifo_w4_d2_S is 
    generic (
...
architecture rtl of calo_trigger_em_jet_stream_ref_fifo_w4_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component calo_trigger_em_jet_stream_ref_fifo_w4_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 4;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_calo_trigger_em_jet_stream_ref_fifo_w4_d2_S_ShiftReg : calo_trigger_em_jet_stream_ref_fifo_w4_d2_S_ShiftReg
    generic map (
...
entity calo_trigger_em_jet_stream_ref_fifo_w4_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 4;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end calo_trigger_em_jet_stream_ref_fifo_w4_d2_S_ShiftReg;

architecture rtl of calo_trigger_em_jet_stream_ref_fifo_w4_d2_S_ShiftReg is
