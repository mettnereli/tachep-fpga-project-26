...
dict set ap_memory_interface_dict clusters_isolation_et { MEM_WIDTH 18 MEM_SIZE 5400 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
...
set C_modelArgList {
	...
	{ clusters_isolation_et int 18 regular {array 1800 { 0 3 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "grid", "interface" : "memory", "bitwidth" : 12, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "clusters_isolation_et", "interface" : "memory", "bitwidth" : 18, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ clusters_isolation_et_d0 sc_out sc_lv 18 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "clusters_isolation_et_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":18, "type": "signal", "bundle":{"name": "clusters_isolation_et", "role": "d0" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "18939", "Max" : "18939"}
	, {"Name" : "Interval", "Min" : "18939", "Max" : "18939"}
]}
...
set Spec2ImplPortList { 
	...
	clusters_isolation_et { ap_memory {  { clusters_isolation_et_address0 mem_address 1 11 }  { clusters_isolation_et_ce0 mem_ce 1 1 }  { clusters_isolation_et_we0 mem_we 1 1 }  { clusters_isolation_et_d0 mem_din 1 18 } } }
